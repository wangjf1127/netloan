...
import { useCreditApprovalDetail } from "../hooks/use-credit-approval"
import type { CreditApprovalDetailProps } from "../types"

export function CreditApprovalDetail({ approvalId, sidebarCollapsed, onToggleSidebar }: CreditApprovalDetailProps) {
  const isMobile = useIsMobile()
  const { data: detail, isLoading, error } = useCreditApprovalDetail(approvalId)
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="space-y-1">
                ...
                <div className="font-medium">{detail.creditSerialNumber}</div>
              </div>
              <div className="space-y-1">
